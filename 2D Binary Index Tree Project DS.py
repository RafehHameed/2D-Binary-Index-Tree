...
o = FenwickTree(4, 4)
o.Print()
print(o.Summation(1, 1, 3, 2), " is the sum from (1,1) to (3,2))")
print(o.Summation(2, 3, 3, 3), " is the sum from (2,3) to (3,3))")
print(o.Summation(1, 1, 1, 1), " is the sum from (1,1) to (1,1))")
